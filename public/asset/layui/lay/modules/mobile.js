...
layui.define(function (e) {
    ...
    d.prototype.view = function () {
        ...
        e.id = s.id = r[0] + o, s.setAttribute("class", r[0] + " " + r[0] + (i.type || 0)), s.setAttribute(
            "index", o);
        var l = function () {
                var e = "object" == typeof i.title;
                return i.title ? '<h3 style="' + (e ? i.title[1] : "") + '">' + (e ? i.title[0] : i.title) +
                    "</h3>" : ""
            }(),
            d = function () {
                ...
                return 0 !== t && i.btn ? (e = '<span yes type="1">' + i.btn[0] + "</span>", 2 === t && (e =
                        '<span no type="0">' + i.btn[1] + "</span>" + e),
                    '<div class="layui-m-layerbtn">' + e + "</div>") : ""
            }();
        if (i.fixed || (i.top = i.hasOwnProperty("top") ? i.top : 100, i.style = i.style || "", i.style +=
                " top:" + (t.body.scrollTop + i.top) + "px"), 2 === i.type && (i.content =
                '<i></i><i class="layui-m-layerload"></i><i></i><p>' + (i.content || "") + "</p>"), i.skin &&
            (i.anim = "up"), "msg" === i.skin && (i.shade = !1), s.innerHTML = (i.shade ? "<div " + (
                    "string" == typeof i.shade ? 'style="' + i.shade + '"' : "") +
                ' class="layui-m-layershade"></div>' : "") + '<div class="layui-m-layermain" ' + (i.fixed ?
                "" : 'style="position:static;"') +
            '><div class="layui-m-layersection"><div class="layui-m-layerchild ' + (i.skin ?
                "layui-m-layer-" + i.skin + " " : "") + (i.className ? i.className : "") + " " + (i.anim ?
                "layui-m-anim-" + i.anim : "") + '" ' + (i.style ? 'style="' + i.style + '"' : "") + ">" +
            l + '<div class="layui-m-layercont">' + i.content + "</div>" + d + "</div></div></div>", !i.type ||
            2 === i.type) {
        ...
        if (e.btn)
            for (var s = t[n]("layui-m-layerbtn")[0].children, o = s.length, r = 0; r < o; r++) l.touch(s[r],
                a);
    ...
    var c = {
        ...
        close: function (e) {
            var i = a("#" + r[0] + e)[0];
            i && (i.innerHTML = "", t.body.removeChild(i), clearTimeout(l.timer[e]), delete l.timer[e],
                "function" == typeof l.end[e] && l.end[e](), delete l.end[e])
        },
        closeAll: function () {
            for (var e = t[n](r[0]), i = 0, a = e.length; i < a; i++) c.close(0 | e[0].getAttribute(
                "index"))
        }
    };
    e("layer-mobile", c)
...
layui.define(function (t) {
    var e = function () {
        ...
        function a(t) {
            var e = !!t && "length" in t && t.length,
                r = T.type(t);
            return "function" != r && !n(t) && ("array" == r || 0 === e || "number" == typeof e && e > 0 &&
                e - 1 in t)
        }
        ...
        function c(t) {
            return t.replace(/::/g, "/").replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(
        ...
        function m(t, e, n) {
            for (j in e) n && (o(e[j]) || Q(e[j])) ? (o(e[j]) && !o(t[j]) && (t[j] = {}), Q(e[j]) && !Q(t[j]) &&
                (t[j] = []), m(t[j], e[j], n)) : e[j] !== E && (t[j] = e[j])
        }
        ...
        function b(t) {
            try {
                return t ? "true" == t || "false" != t && ("null" == t ? null : +t + "" == t ? +t :
        ...
        return Y.matches = function (t, e) {
                ...
                var r, i, a;
                return R.test(t) && (r = T(L.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(
                        z, "<$1></$2>")), e === E && (e = M.test(t) && RegExp.$1), e in B || (e = "*"),
                    a = B[e], a.innerHTML = "" + t, r = T.each(D.call(a.childNodes), function () {
                        a.removeChild(this)
                ...
                var n, r = "#" == e[0],
                    ...
                    o = r || i ? e.slice(1) : e,
                    a = X.test(o);
                return t.getElementById && a && r ? (n = t.getElementById(o)) ? [n] : [] : 1 !== t.nodeType &&
                    9 !== t.nodeType && 11 !== t.nodeType ? [] : D.call(a && !r && t.getElementsByClassName ?
                        i ? t.getElementsByClassName(o) : t.getElementsByTagName(e) : t.querySelectorAll(e)
                    )
                ...
                for (; e && (e = e.parentNode);)
                    if (e === t) return !0;
                return !1
            }, T.type = t, T.isFunction = e, T.isWindow = n, T.isArray = Q, T.isPlainObject = o, T.isEmptyObject =
            function (t) {
                var e;
                for (e in t) return !1;
                return !0
                ...
                var e = Number(t),
                    n = typeof t;
                return null != t && "boolean" != n && ("string" != n || t.length) && !isNaN(e) && isFinite(
                    e) || !1
                ...
                concat: function () {
                    var t, e, n = [];
                    for (t = 0; t < arguments.length; t++) e = arguments[t], n[t] = Y.isZ(e) ? e.toArray() :
                        e;
                ...
                ready: function (t) {
                    return U.test(L.readyState) && L.body ? t(T) : L.addEventListener(
                        "DOMContentLoaded",
                        function () {
                            t(T)
                        }, !1), this
                ...
                not: function (t) {
                    ...
                    if (e(t) && t.call !== E) this.each(function (e) {
                        ...
                        var r = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? D.call(t) :
                            T(t);
                ...
                closest: function (t, e) {
                    ...
                    return this.each(function (o, a) {
                        for (; a && !(i ? i.indexOf(a) >= 0 : Y.matches(a, t));) a = a !== e &&
                            !r(a) && a.parentNode;
                ...
                show: function () {
                    return this.each(function () {
                        "none" == this.style.display && (this.style.display = ""), "none" ==
                            getComputedStyle(this, "").getPropertyValue("display") && (this.style
                                .display = h(this.nodeName))
                    })
                },
                ...
                css: function (e, n) {
                    ...
                    if ("string" == t(e)) n || 0 === n ? a = c(e) + ":" + f(e, n) : this.each(function () {
                        ...
                        for (j in e) e[j] || 0 === e[j] ? a += c(j) + ":" + f(j, e[j]) + ";" : this.each(
                            function () {
                ...
                toggleClass: function (t, e) {
                    return t ? this.each(function (n) {
                        ...
                        i.split(/\s+/g).forEach(function (t) {
                            (e === E ? !r.hasClass(t) : e) ? r.addClass(t): r.removeClass(
                                t)
                        })
                    }) : this
                },
                ...
                position: function () {
                    if (this.length) {
                        ...
                        return n.top -= parseFloat(T(t).css("margin-top")) || 0, n.left -= parseFloat(T(
                            t).css("margin-left")) || 0, r.top += parseFloat(T(e[0]).css(
                            "border-top-width")) || 0, r.left += parseFloat(T(e[0]).css(
                            "border-left-width")) || 0, {
                            top: n.top - r.top,
                            left: n.left - r.left
                        }
                ...
                offsetParent: function () {
                    return this.map(function () {
                        for (var t = this.offsetParent || L.body; t && !Z.test(t.nodeName) &&
                            "static" == T(t).css("position");) t = t.offsetParent;
                        return t
                    })
                }
                ...
                T.fn[t] = function (i) {
                    var o, a = this[0];
                    return i === E ? n(a) ? a["inner" + e] : r(a) ? a.documentElement["scroll" + e] :
                        (o = this.offset()) && o[t] : this.each(function (e) {
                ...
                T.fn[e] = function () {
                    var e, i, o = T.map(arguments, function (n) {
                            ...
                            return e = t(n), "array" == e ? (n.forEach(function (t) {
                                return t.nodeType !== E ? r.push(t) : T.zepto.isZ(t) ?
                                    r = r.concat(t.get()) : void(r = r.concat(Y.fragment(
                                        t)))
                            }), r) : "object" == e || null == n ? n : Y.fragment(n)
                        }),
                        a = this.length > 1;
                    return o.length < 1 ? this : this.each(function (t, e) {
                        i = r ? e : e.parentNode, e = 0 == n ? e.nextSibling : 1 == n ? e.firstChild :
                            2 == n ? e : null;
                        ...
                        o.forEach(function (t) {
                            ...
                            i.insertBefore(t, e), s && w(t, function (t) {
                                if (!(null == t.nodeName || "SCRIPT" !== t.nodeName
                                        .toUpperCase() || t.type &&
                                        "text/javascript" !== t.type || t.src
                                    )) {
                                    var e = t.ownerDocument ? t.ownerDocument
                                        .defaultView : window;
    ...
    ! function (t) {
        ...
        function n(t, n, o, a) {
            ...
            return (v[e(t)] || []).filter(function (t) {
                return t && (!n.e || t.e == n.e) && (!n.ns || s.test(t.ns)) && (!o || e(t.fn) === e(o)) &&
                    (!a || t.sel == a)
            })
        }
        ...
        function s(n, i, s, u, l, h, p) {
            ...
            i.split(/\s/).forEach(function (e) {
                ...
                i.fn = s, i.sel = l, i.e in b && (s = function (e) {
                    ...
                    if (!n || n !== this && !t.contains(this, n)) return i.fn.apply(this,
                        arguments)
                }), i.del = h;
                var d = h || s;
                i.proxy = function (t) {
                ...
                }, i.i = m.length, m.push(i), "addEventListener" in n && n.addEventListener(a(i.e),
                    i.proxy, o(i, p))
            })
        }
        ...
        function u(t, r, i, s, u) {
            ...
            (r || "").split(/\s/).forEach(function (e) {
                n(t, e, i, s).forEach(function (e) {
                    delete v[c][e.i], "removeEventListener" in t && t.removeEventListener(a(e.e),
                        e.proxy, o(e, u))
                })
            })
        }
        ...
        function c(e, n) {
            ...
            }), e.timeStamp || (e.timeStamp = Date.now()), (n.defaultPrevented !== f ? n.defaultPrevented :
        ...
        t.fn.delegate = function (t, e, n) {
                ...
                return e && !m(e) ? (t.each(e, function (t, e) {
                    h.on(t, n, r, e, o)
                }), h) : (m(n) || d(i) || i === !1 || (i = r, r = n, n = f), i !== f && r !== !1 || (i = r,
                ...
                return e = m(e) || t.isPlainObject(e) ? t.Event(e) : c(e), e._args = n, this.each(function () {
                    e.type in x && "function" == typeof this[e.type] ? this[e.type]() : "dispatchEvent" in
                        this ? this.dispatchEvent(e) : t(this).triggerHandler(e, n)
                })
            }, t.fn.triggerHandler = function (e, r) {
                var i, o;
                return this.each(function (a, s) {
                    i = l(m(e) ? t.Event(e) : e), i._args = r, i.target = s, t.each(n(s, e.type || e),
                        function (t, e) {
    ...
    function (t) {
        ...
        function o(t, e) {
            var r = e.context;
            return e.beforeSend.call(r, t, e) !== !1 && n(e, r, "ajaxBeforeSend", [t, e]) !== !1 && void n(e, r,
                "ajaxSend", [t, e])
        }
        ...
        function a(t, e, r, i) {
            var o = r.context,
                a = "success";
            r.success.call(o, t, a, e), i && i.resolveWith(o, [t, a, e]), n(r, o, "ajaxSuccess", [e, r, t]), u(
                a, e, r)
        }

        function s(t, e, r, i, o) {
            var a = i.context;
            i.error.call(a, r, e, t), o && o.rejectWith(a, [r, e, t]), n(i, a, "ajaxError", [r, i, t || e]), u(
                e, r, i)
        }
        ...
        function f(t) {
            return t && (t = t.split(";", 2)[0]), t && (t == T ? "html" : t == j ? "json" : w.test(t) ?
                "script" : E.test(t) && "xml") || "text"
        }
        ...
        function p(e) {
            e.processData && e.data && "string" != t.type(e.data) && (e.data = t.param(e.data, e.traditional)),
                !e.data || e.type && "GET" != e.type.toUpperCase() && "jsonp" != e.dataType || (e.url = h(e.url,
        ...
        function m(e, n, r, i) {
            ...
            t.each(n, function (n, u) {
                o = t.type(u), i && (n = r ? i : i + "[" + (s || "object" == o || "array" == o ? n : "") +
                        "]"), !i && a ? e.add(u.name, u.value) : "array" == o || !r && "object" == o ?
                    m(e, u, r, n) : e.add(n, u)
            })
        }
        var v, g, y = +new Date,
        ...
        C.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
            ...
            return n && n.promise(p), t(l).on("load error", function (o, u) {
                clearTimeout(i), t(l).off().remove(), "error" != o.type && r ? a(r[0], p, e, n) : s(
                        null, u || "error", p, e, n), window[c] = f, r && t.isFunction(f) && f(r[0]),
                    f = r = void 0
            }), o(p, e) === !1 ? (h("abort"), p) : (window[c] = function () {
                    r = arguments
                }, l.src = e.url.replace(/\?(.+)=\?/, "?$1=" + c), x.head.appendChild(l), e.timeout > 0 &&
            ...
            r(u), u.crossDomain || (n = x.createElement("a"), n.href = u.url, n.href = n.href, u.crossDomain =
                C.protocol + "//" + C.host != n.protocol + "//" + n.host), u.url || (u.url = window.location
                .toString()), (i = u.url.indexOf("#")) > -1 && (u.url = u.url.slice(0, i)), p(u);
            var m = u.dataType,
                y = /\?.+=\?/.test(u.url);
            if (y && (m = "jsonp"), u.cache !== !1 && (e && e.cache === !0 || "script" != m && "jsonp" != m) ||
                (u.url = h(u.url, "_=" + Date.now())), "jsonp" == m) return y || (u.url = h(u.url, u.jsonp ?
                u.jsonp + "=?" : u.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(u, d);
            var b, w = u.accepts[m],
                E = {},
                j = function (t, e) {
                    E[t.toLowerCase()] = [t, e]
            ...
            if (d && d.promise(N), u.crossDomain || j("X-Requested-With", "XMLHttpRequest"), j("Accept", w ||
                    "*/*"), (w = u.mimeType || w) && (w.indexOf(",") > -1 && (w = w.split(",", 2)[0]), N.overrideMimeType &&
                    N.overrideMimeType(w)), (u.contentType || u.contentType !== !1 && u.data && "GET" != u.type
                    .toUpperCase()) && j("Content-Type", u.contentType ||
            ...
            if (N.setRequestHeader = j, N.onreadystatechange = function () {
                    if (4 == N.readyState) {
                        ...
                        var e, n = !1;
                        if (N.status >= 200 && N.status < 300 || 304 == N.status || 0 == N.status &&
                            "file:" == T) {
                            if (m = m || f(u.mimeType || N.getResponseHeader("content-type")),
                                "arraybuffer" == N.responseType || "blob" == N.responseType) e = N.response;
                            else {
                                e = N.responseText;
                                try {
                                    e = c(e, m, u), "script" == m ? (0, eval)(e) : "xml" == m ? e = N.responseXML :
                                        "json" == m && (e = S.test(e) ? null : t.parseJSON(e))
                                } catch (r) {
                                    n = r
                                }
            ...
            return this[0] && t.each(this[0].elements, function (r, o) {
                n = o.type, e = o.name, e && "fieldset" != o.nodeName.toLowerCase() && !o.disabled &&
                    "submit" != n && "reset" != n && "button" != n && "file" != n && ("radio" != n &&
                        "checkbox" != n || o.checked) && i(t(o).val())
            }), r
    ...
    s.prototype.init = function () {
        ...
        return t("#" + n)[0] || r.append(u), s.each(function (r, s) {
            ...
            var u = '<form target="' + n + '" method="' + (a.method || "post") +
                '" key="set-mine" enctype="multipart/form-data" action="' + (a.url || "") +
                '"></form>',
                l = s.attr("lay-type") || a.type;
            a.unwrap || (u = '<div class="layui-box layui-upload-button">' + u +
                '<span class="layui-upload-icon"><i class="layui-icon"></i>' + (s.attr(
                    "lay-title") || a.title || "上传" + (o[l] || "图片")) + "</span></div>"), u = t(
                u), a.unwrap || u.on("dragover", function (e) {
                e.preventDefault(), t(this).addClass(i)
            }).on("dragleave", function () {
                t(this).removeClass(i)
            }).on("drop", function () {
                t(this).removeClass(i)
            }), s.parent("form").attr("target") === n && (a.unwrap ? s.unwrap() : (s.parent().next()
                .remove(), s.unwrap().unwrap())), s.wrap(u), s.off("change").on("change",
                function () {
                    e.action(this, l)
                })
        })
        ...
        if (u) {
            switch (i) {
                case "file":
                    ...
                    break;
                case "video":
                    if (!RegExp("\\w\\.(" + (p || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$", "i").test(
                            escape(u))) return a.msg("不支持该视频格式", r), e.value = "";
                    break;
                case "audio":
                    if (!RegExp("\\w\\.(" + (p || "mp3|wav|mid") + ")$", "i").test(escape(u))) return a.msg(
                        "不支持该音频格式", r), e.value = "";
                    break;
                default:
...
layui.define(["laytpl", "upload-mobile", "layer-mobile", "zepto"], function (i) {
    var e = "2.1.0",
        ...
        m = function (i, e, t) {
            var n, l = "function" == typeof e,
                s = function (i) {
                    var e = a(this);
                    e.data("lock") || (n || t.call(this, i), n = !1, e.data("lock", "true"), setTimeout(
                        function () {
    ...
    var p = function (i) {
            ...
            return i = i || {}, "history" === i.type && (i.item = i.item || "d.sortHistory"), [
                "{{# var length = 0; layui.each(" + i.item + ", function(i, data){ length++; }}",
                '<li layim-event="chat" data-type="' + i.type + '" data-index="' + (i.index ? "{{" + i.index +
                    "}}" : ("history" === i.type ? "{{data.type}}" : i.type) + "{{data.id}}") +
                '" class="layim-' + ("history" === i.type ? "{{data.type}}" : i.type) +
                ...
                "{{# }); if(length === 0){ }}", '<li class="layim-null">' + (e[i.type] || "暂无数据") + "</li>",
                "{{# } }}"].join("")
        },
        f = function (i, e, a) {
            return ['<div class="layim-panel' + (e ? " layui-m-anim-left" : "") + '">',
                '<div class="layim-title" style="background-color: {{d.base.chatTitleColor}};">', "<p>", a ?
                '<i class="layui-icon layim-chat-back" layim-event="back"></i>' : "",
                '{{ d.title || d.base.title }}<span class="layim-chat-status"></span>',
                "{{# if(d.data){ }}", '{{# if(d.data.type === "group"){ }}',
                '<i class="layui-icon layim-chat-detail" layim-event="detail"></i>', "{{# } }}",
                "{{# } }}", "</p>", "</div>", '<div class="layui-unselect layim-content">', i, "</div>",
                "</div>"].join("")
        },
        h = ['<div class="layui-layim">', '<div class="layim-tab-content layui-show">',
            '<ul class="layim-list-friend">', '<ul class="layui-layim-list layui-show layim-list-history">', p({
                type: "history"
            }), "</ul>", "</ul>", "</div>", '<div class="layim-tab-content">', '<ul class="layim-list-top">',
            ...
            '<ul class="layui-layim-list {{# if(spread === "true"){ }}', " layui-show", '{{# } }}">', p({
                type: "friend",
                item: "item.list",
                index: "index"
            }), "</ul>", "</li>", "{{# }); if(d.friend.length === 0){ }}",
            '<li><ul class="layui-layim-list layui-show"><li class="layim-null">暂无联系人</li></ul>', "{{# } }}",
            "</ul>", "</div>", '<div class="layim-tab-content">', '<ul class="layim-list-top">',
    ...
    layui.data.date = function (i) {
        ...
        return i = (i || "").replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&").replace(/</g, "<").replace(/>/g,
            ">").replace(/'/g, "'").replace(/"/g, "&#39;").replace(/@(\S+)(\s+?|$)/g,
            '@<a href="javascript:;">$1</a>$2').replace(/face\[([^\s\[\]]+?)\]/g, function (i) {
            ...
            var e = (i.match(/file\(([\s\S]+?)\)\[/) || [])[1],
                a = (i.match(/\)\[([\s\S]*?)\]/) || [])[1];
            return e ? '<a class="layui-layim-file" href="' + e +
                '" download target="_blank"><i class="layui-icon"></i><cite>' + (a || e) +
                "</cite></a>" : i
        }).replace(/audio\[([^\s]+?)\]/g, function (i) {
            return '<div class="layui-unselect layui-layim-audio" layim-event="playAudio" data-src="' +
                i.replace(/(^audio\[)|(\]$)/g, "") +
                '"><i class="layui-icon"></i><p>音频消息</p></div>'
        }).replace(/video\[([^\s]+?)\]/g, function (i) {
            return '<div class="layui-unselect layui-layim-video" layim-event="playVideo" data-src="' +
                i.replace(/(^video\[)|(\]$)/g, "") + '"><i class="layui-icon"></i></div>'
    ...
    var b, x, w = ['<li onclick="window.qxs_m_msg_click(this)" class="layim-chat-li{{ d.mine ? " layim-chat-mine" : "" }}" {{# if(d.cid){ }}data-cid="{{d.cid}}"{{# } }}>',
        ...
        k = function (i) {
            ...
            return mine = e.mine || {}, local = layui.data("layim-mobile")[mine.id] || {}, obj = {
                ...
                s.sortHistory = j(s.history, "historyTime"), C = a.extend(C, s), S(t(f(h)).render(s)),
        ...
        S = function (i) {
            return n.open({
                ...
                content: i,
                success: function (i) {
                    b = a(i), T(b.find(".layui-layim")), C.base.tabIndex && U.tab(a(
                        ".layui-layim-tab>li").eq(C.base.tabIndex))
                }
            })
        },
        N = function (i, e) {
            ...
            return n.open({
                ...
                success: function (e) {
                    var t = a(e);
                    t.prev().find(".layim-panel").addClass("layui-m-anim-lout"), i.success && i.success(
                        e), i.isChat || T(t.find(".layim-content"))
                },
                end: i.end
            })
        },
        ...
        T = function (i) {
            s.ios && i.on("touchmove", function (e) {
                var a = i.scrollTop();
                a <= 0 && (i.scrollTop(1), e.preventDefault(e)), this.scrollHeight - a - i.height() <=
                    0 && (i.scrollTop(i.scrollTop() - 1), e.preventDefault(e))
            })
        },
        A = function () {
            if (!x) return {};
        ...
        H = function (i) {
            ...
            if (b) {
                ...
                i.historyTime = (new Date).getTime(), i.sign = i.content, n[i.type + i.id] = i, e.history = n,
                    layui.data("layim-mobile", {
                        key: C.mine.id,
                        value: e
                    });
                var s = l.find(".layim-" + i.type + i.id),
                    ...
                    d = function () {
                        s = l.find(".layim-" + i.type + i.id), s.find("p").html(i.content), c > 0 && s.find(
                            ".layim-msg-status").html(c).addClass(o)
                    };
        ...
        M = function (i) {
            ...
            i.timestamp = i.timestamp || (new Date).getTime(), i.system || F(i), D = JSON.parse(JSON.stringify(
                i)), C.base.voice && _(), (!x && i.content || !s) && (C.message[i.type + i.id] ? C.message[
                i.type + i.id].push(i) : C.message[i.type + i.id] = [i]);
            var e = {};
            if ("friend" === i.type) {
                var o;
                ...
                if (t.id == i.id) return i.type = "group", i.name = i.groupname = t.groupname, e.avatar =
                    t.avatar, !0
            ...
            if ("group" === i.type && delete c.username, H(c), x && s) {
                ...
                i.system ? r.append('<li class="layim-chat-system"><span>' + i.content + "</span></li>") : "" !==
                    i.content.replace(/\s/g, "") && (i.timestamp - (q.time || 0) > 6e4 && (r.append(
                        '<li class="layim-chat-system"><span>' + layui.data.date(i.timestamp) +
                        "</span></li>"), q.time = i.timestamp), r.append(t(w).render(i))), J()
            }
        },
        F = function (i) {
            var e = layui.data("layim-mobile")[C.mine.id] || {},
                a = e.chatlog || {};
            a[i.type + i.id] ? (a[i.type + i.id].push(i), a[i.type + i.id].length > d && a[i.type + i.id].shift()) :
                a[i.type + i.id] = [i], e.chatlog = a, layui.data("layim-mobile", {
                    key: C.mine.id,
                    value: e
                })
        },
        $ = function () {
            ...
            layui.each(a[e.data.type + e.data.id], function (i, e) {
                (new Date).getTime() > e.timestamp && e.timestamp - (q.time || 0) > 6e4 && (n.append(
                    '<li class="layim-chat-system"><span>' + layui.data.date(e.timestamp) +
                    "</span></li>"), q.time = e.timestamp), n.append(t(w).render(e))
            }), J()
        },
        O = function (i) {
            var e, a = {},
            ...
            if (C[i.type])
                if ("friend" === i.type) layui.each(C.friend, function (t, l) {
                    if (i.groupid == l.id) return layui.each(C.friend[t].list, function (a, t) {
                        ...
                        anim: 6
                    }) : (C.friend[t].list = C.friend[t].list || [], a[C.friend[t].list.length] =
                        i, i.groupIndex = t, C.friend[t].list.push(i), !0)
                });
            ...
            if (!e) {
                ...
                if ("friend" === i.type) {
                    ...
                    o.find(".layui-layim-list").append(s), o.find(".layim-count").html(C.friend[i.groupIndex].list
                        .length), o.find(".layim-null")[0] && o.find(".layim-null").remove()
            ...
            C[i.type] && ("friend" === i.type ? layui.each(C.friend, function (a, t) {
                layui.each(t.list, function (t, n) {
                    if (i.id == n.id) {
                        ...
                        return l.find(".layui-layim-list").children("li").eq(t).remove(), C
                            .friend[a].list.splice(t, 1), l.find(".layim-count").html(C.friend[
                                a].list.length), 0 === C.friend[a].list.length && l.find(
                                ".layui-layim-list").html(
                                '<li class="layim-null">该分组下已无好友了</li>'), !0
                    }
                })
            }) : "group" === i.type && layui.each(C.group, function (a, t) {
                if (i.id == t.id) return e.children("li").eq(a).remove(), C.group.splice(a, 1), 0 ===
                    C.group.length && e.html('<li class="layim-null">暂无群组</li>'), !0
            }))
        },
        J = function () {
            var i = A(),
        ...
        B = function () {
            ...
            e.off("keyup").on("keyup", function (i) {
                var t = i.keyCode;
                13 === t && (i.preventDefault(), q()), a["" === e.val() ? "addClass" : "removeClass"](
                    "layui-disabled")
            })
        },
        E = function () {
            var i = ["[微笑]", "[嘻嘻]", "[哈哈]", "[可爱]", "[可怜]", "[挖鼻]", "[吃惊]", "[害羞]", "[挤眼]", "[闭嘴]", "[鄙视]",
        ...
        R = function (i, e, a) {
            var t, n = i.value;
            a || i.focus(), document.selection ? (t = document.selection.createRange(), document.selection.empty(),
                t.text = e) : (t = [n.substring(0, i.selectionStart), e, n.substr(i.selectionEnd)], a || i.focus(),
                i.value = t.join(""))
        },
        U = {
            chat: function (i) {
                var e = layui.data("layim-mobile")[C.mine.id] || {},
                    ...
                    s = {};
                "friend" === t ? s = C[t][n].list[l] : "group" === t ? s = C[t][l] : "history" === t && (s =
                        (e.history || {})[n] || {}), s.name = s.name || s.username || s.groupname,
                    "history" !== t && (s.type = t), L(s, !0), a(".layim-" + s.type + s.id).find(
                        ".layim-msg-status").removeClass(o)
            },
            spread: function (i) {
                var e = i.attr("lay-type"),
                    a = "true" === e ? "false" : "true",
                    t = layui.data("layim-mobile")[C.mine.id] || {};
                i.next()["true" === e ? "removeClass" : "addClass"](o), t["spread" + i.parent().index()] =
                    a, layui.data("layim-mobile", {
                        key: C.mine.id,
                        value: t
            ...
            tab: function (i) {
                var e = i.index(),
                    a = ".layim-tab-content";
                i.addClass(c).siblings().removeClass(c), b.find(a).eq(e).addClass(o).siblings(a).removeClass(
                    o)
            },
            back: function (i) {
                ...
                setTimeout(function () {
                    n.close(a)
                }, 300), i.parents(t).eq(0).removeClass("layui-m-anim-left").addClass(
                    "layui-m-anim-rout"), e.prev().find(t).eq(0).removeClass("layui-m-anim-lout").addClass(
                    "layui-m-anim-right"), layui.each(r.back, function (i, e) {
                    setTimeout(function () {
                        e && e()
                    }, 200)
                })
            ...
            face: function (i, e) {
                ...
                layui.each(E, function (i, e) {
                    ...
                    success: function (i) {
                        ...
                        m(e, function () {
                            return R(s[0], "face" + this.title + " ", !0), s.next()["" ===
                ...
                var o = a(document);
                y ? o.off("touchend", U.faceHide).on("touchend", U.faceHide) : o.off("click", U.faceHide).on(
                    "click", U.faceHide), P(e)
            },
            faceHide: function () {
                n.close(n.popBottom.index), a(document).off("touchend", U.faceHide).off("click", U.faceHide)
            },
            image: function (i) {
                var ee = i.data("type") || "images",
                    a = {
                        images: "uploadImage",
                        file: "uploadFile"
                    },
                    ...
                    i.find("input")[0].onchange = function(e){
            ...
            playAudio: function (i) {
                ...
                return i.data("error") ? n.msg("播放音频源异常") : a.play ? void(i.attr("status") ? t() : (e || (a
                    .src = i.data("src")), a.play(), i.attr("status", "pause"), i.data("audio",
                    a), i.find("i").html(""), a.onended = function () {
                    t()
                }, a.onerror = function () {
            ...
            about: function () {
                n.open({
                    content: '<p style="padding-bottom: 5px;">LayIM属于付费产品，欢迎通过官网获得授权，促进良性发展！</p><p>当前版本：layim mobile v' +
                        e + '</p><p>版权所有：<a href="#">PHPVINCENT</a></p>',
